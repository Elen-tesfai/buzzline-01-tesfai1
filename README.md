...
py -m producers.basic_producer_tesfai
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m producers.basic_producer_tesfai
```
...
```shell
.venv\Scripts\activate
py -m consumers.basic_consumer_tesfai
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m consumers.basic_consumer_tesfai
```
